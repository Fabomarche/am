...
const mb_title_1 = document.getElementById('1-mb-testimonio-title')
const mb_title_2 = document.getElementById('2-mb-testimonio-title')
const mb_title_3 = document.getElementById('3-mb-testimonio-title')
const mb_title_4 = document.getElementById('4-mb-testimonio-title')
...
const mb_p_1 = document.getElementById('1-mb-testimonio-p')
const mb_p_2 = document.getElementById('2-mb-testimonio-p')
const mb_p_3 = document.getElementById('3-mb-testimonio-p')
const mb_p_4 = document.getElementById('4-mb-testimonio-p')
...
const mb_alumno_1 = document.getElementById('1-mb-testimonio-alumno')
const mb_alumno_2 = document.getElementById('2-mb-testimonio-alumno')
const mb_alumno_3 = document.getElementById('3-mb-testimonio-alumno')
const mb_alumno_4 = document.getElementById('4-mb-testimonio-alumno')
...
const consistency_testimonios = () => {
    if(sessionStorage.getItem('carrerra') === 'Arquitectura'){
        ...
        alumno_1.innerText = mb_alumno_1.innerText = 'Dandara Grima'
        
        title_2.innerText = mb_title_2.innerText =`"Me parece muy bueno poder ir debatiendo temas"`
        p_2.innerText = mb_p_2.innerText = `Hice el curso intensivo a unas semanas de terminar el cursado.
        ...
        `
        alumno_2.innerText = mb_alumno_2.innerText = 'Luz Barboza'
        
        title_3.innerText = mb_title_3.innerText =`"La predisposición de enseñar se notaba en cada clase"`
        p_3.innerText = mb_p_3.innerText = `A mitad de año, durante el cursado de Geometría Descriptiva,
        ...
        p_3.innerText = mb_p_3.innerText = `Siendo un ingresante en la carrera de medicina fue todo un desafío hacer frente a la amplia variedad de temas y conceptos a aprender. Necesitaba un acompañamiento pedagógico más allá de los seminarios y tutorías de la facultad. Entonces descubrí las clases de medicina de AM.
