...
const consistency_testimonios = () => {
    if(sessionStorage.getItem('carrerra') === 'Arquitectura'){
        title_1.innerText = `Geometría descriptiva para mi (y para muchos de mis compañeros)`
        ...
        p_2.innerText = `Hice el curso intensivo a unas semanas de terminar el cursado. Aprobé los temas que nos faltaban dar y los recuperatorios de lo que me había rendido mal. 
        Me parece muy bueno poder ir debatiendo e ir consultando dudas en las clases y también tener los videos para repasar dudas que fueron quedando. 
        ¡Es súper recomendable! 
        `
        title_3.innerText =`A mitad de año, durante el cursado de Geometría Descriptiva,`
